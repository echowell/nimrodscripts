...
def surfmn_runner(file_name=None,show_plot=True,pickle_data=False,\
  ...
  if pre in dump_pre:
    print(f"Calculating surmn fsa from dump file")
...
if __name__ == "__main__":
  ...
  print(args)
  surfmn_runner(file_name=args['file'],show_plot=args['plot'],\
