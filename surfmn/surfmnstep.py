...
# Update plot based on keys in kwargs
  ...
  def get_resonance(self,field,nn,mm):
    ...
    def load(self,file):
      pickle.load(self.surfmn_file,file)
      pickle.load(self.dumpfile,file)
      pickle.load(self.step,file)
      pickle.load(self.time,file)
      pickle.load(self.mmax,file)
      pickle.load(self.surfmn_data,file)
      pickle.load(self.nlist,file)
      pickle.load(self.ndict,file)
      pickle.load(self.bmnlist,file)
      pickle.load(self.psimnlist,file)
      pickle.load(self.rho,file)
      pickle.load(self.vprime,file)
      pickle.load(self.q,file)
      pickle.load(self.mr,file)
      pickle.load(self.psi_q,file)
      pickle.load(self.qmin,file)
      pickle.load(self.qmax,file)
