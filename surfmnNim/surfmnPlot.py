...
if plotmag2wall==1:
    ...
    ax.plot(rho1,bnmflip[xyfile,11].real,color='m',label='m=-1',lw=3)
    ax.plot(rho1,bnmflip[xyfile,12].real,color='r',label='m=-2',lw=3)
    ax.plot(rho1,bnmflip[xyfile,13].real,color='b',label='m=-3',lw=3)
    ax.plot(rho1,bnmflip[xyfile,14].real,color='g',label='m=-4',lw=3)
    ax.plot(rho1,bnmflip[xyfile,15].real,color='y',label='m=-5',lw=3)
    ax.plot(rho1,bnmflip[xyfile,16].real,color='lime',label='m=-6',lw=3)
...
if plotmag==1:
    ...
    fig,ax=plt.subplots(figsize=(6,6))
    ax.plot(rho[fgfile],bnmflip[xyfile,11,1:ibmax].real,color='m',label='m=-1',lw=3)
    ax.plot(rho[fgfile],bnmflip[xyfile,12,1:ibmax].real,color='r',label='m=-2',lw=3)
    ax.plot(rho[fgfile],bnmflip[xyfile,13,1:ibmax].real,color='b',label='m=-3',lw=3)
    ax.plot(rho[fgfile],bnmflip[xyfile,14,1:ibmax].real,color='g',label='m=-4',lw=3)
...
#    CS = ax.contourf(m,rho[fgfile],bm2,levels,cmap=cm.seismic)
    ...
    ax.plot(q1[:479],rho[fgfile],c='white',lw=5,ls='dashed',label=r'$m=qn$')
